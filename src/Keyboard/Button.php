...
use Telegram\Bot\Objects\CallbackGame;
 ...
 * @method $this setSwitchInlineQueryCurrentChat($string)  (Inline Button Only) Optional. If set, If set, pressing the button will insert the bot‘s username and the specified inline query in the current chat's input field. Can be empty, in which case only the bot’s username will be inserted.
 * @method $this setCallbackGame(CallbackGame $game)       (Inline Button Only) Optional. Description of the game that will be launched when the user presses the button.
 */
